...
local UI_TARGET_WIDTH_RATIO = (LayoutTuning and LayoutTuning.TargetWidthRatioOverride) or UIConstants.TargetWidthRatio
...
local PREVIEW_USED_FRAME_OFFSET_X = UIConstants.PreviewUsedFrameOffsetX or 0
local PREVIEW_USED_FRAME_OFFSET_Y = UIConstants.PreviewUsedFrameOffsetY or 0
local PREVIEW_USED_FRAME_SIZE_DELTA = UIConstants.PreviewUsedFrameSizeDelta or 0
...
local function RefreshContext()
    ...
    Context.PREVIEW_USED_FRAME_OFFSET_X = PREVIEW_USED_FRAME_OFFSET_X
    Context.PREVIEW_USED_FRAME_OFFSET_Y = PREVIEW_USED_FRAME_OFFSET_Y
    Context.PREVIEW_USED_FRAME_SIZE_DELTA = PREVIEW_USED_FRAME_SIZE_DELTA
