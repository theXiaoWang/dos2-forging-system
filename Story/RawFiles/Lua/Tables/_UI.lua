...
function BaseUI.Create(id, typeID, tbl)
    tbl = OOP.GetClass("Library").Create("forging_system", id, tbl)
...
Ext.Events.UICall:Subscribe(function(ev)
    ...
    -- TODO improve
    local relativePath = string.match(ev.UI.Path, "(Public/forging_system_d581d214%-2dd4%-4690%-bb44%-e371432f1bfc/GUI/.*%.swf)$")
    if relativePath and not string.match(ev.UI.Path, "(Public/forging_system_d581d214%-2dd4%-4690%-bb44%-e371432f1bfc/GUI/generic%.swf)$") then
