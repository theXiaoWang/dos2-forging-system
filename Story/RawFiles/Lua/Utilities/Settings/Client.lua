...
Settings.DEFAULT_SAVE_FILENAME = "forging_system/Settings/%s/%s.json"
...
---@param fileName string? Defaults to "forging_system/Settings/{profileGUID}/{moduleName}.json"
function Settings.Save(moduleName, fileName)
    ...
    if module then
        ...
        IO.SaveFile("forging_system/ignore.txt", "")
        IO.SaveFile("forging_system/Settings/ignore.txt", "")
